          ...
          <div className="container-fluid header_nav d-flex align-items-center justify-content-between">
                ...
                <li>
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>
                        <Link to="/seo-detail">SEO Detail</Link>
                      </li>
                      <li>
                        <Link to="/web-detail">Web Detail</Link>
                      </li>
                      <li>
            ...
            <div className="navmenu_end">
              <ul>
                ...
                <li>
                  <Link to="/contact">Request For Proposal</Link>
                </li>
              </ul>
            </div>
          </div>
