  ...
  return (
    <>
      ...
      <div className="breadcrumb">
        ...
        <NavLink to="/seo-detail">Services</NavLink>
        {/* </div> */}
      </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="project-img">
                <img src="images/seo-detail-project.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid">
          <div className="row gy-4">
            <div className="col-md-6 col-lg-7 content-col">
              <div className="icon">
                <img src="images/yoy-arrow.svg" alt="" />
              </div>
      ...
      <section className="seo-action-result pad_cmn_blk">
        <div className="container">
          ...
          <div className="row gy-4 align-items-center">
            ...
            <div className="col-md-6">
              <img src="images/action-result.png" alt="" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="key-takeaway-wrapper">
            ...
            <div className="row gy-3">
              ...
              <div className="col-md-6">
                <img src="images/key-takeaways.png" alt="" />
              </div>
            </div>
          </div>
        </div>
