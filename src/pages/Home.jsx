...
const Home = () => {
  ...
  {pageData.discover_repeater ? ( 
      <section className="discover_blk pad_cmn_blk d-none d-lg-block" ref={sectionRef}>
        {/**ref={sectionRef} */}
        <div className="container">
          <div className="row">
                ...
                {pageData.discover_repeater.map((row, j) => {
                  ...
                  <div className="col-md-6" key={j}>
                    <div className="discover-card">
                      <img src={row.discover_repeater_image} alt={row.discover_repeater_title} />
                      <h4>{row.discover_repeater_title}</h4>
                      <p>
                      {row.discover_repeater_description}
                      </p>
                    </div>
                  </div>
                    );
                ...
                <div className="row">
                  <div className="col pe-0 ps-0">
                    ...
                    {pageData.discover_repeater.map((mrow, k) => {
                      ...
                      <div className="" key={k}>
                        <div className="discover-card">
                          <img src={mrow.discover_repeater_image} alt={mrow.discover_repeater_title} />
                          <h4>{mrow.discover_repeater_title}</h4>
                          <p>
                          {mrow.discover_repeater_description}
                          </p>
                        </div>
                      </div>
                       );
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="title_blk">
                ...
                <p>
                {pageData.section_description_intgrtd}
                </p>
              </div>
