          ...
          <div className="row">
            <div className="col">
              <div className="contact_blk">
                <div>
                  <div className="logo">
                    <img src="images/gwebpro_call.png" alt="" />
                  </div>
                  <div className="text">
                    <p>Connect With Us On Call</p>
                    <Link to="tel:1-888-445-3334">1-888-445-3334</Link>
                  </div>
                </div>
                <div>
                  <div className="logo">
                    <img src="images/gwebpro_email.png" alt="" />
                  </div>
                  <div className="text">
                    <p>Connect With Us Via Email</p>
                    <Link to="mailto:info@samplemail.com">
                      info@samplemail.com
                    </Link>
                  </div>
                </div>
